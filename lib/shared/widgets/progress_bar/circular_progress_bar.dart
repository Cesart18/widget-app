...
class CircularProgressBar extends StatefulWidget {
  ...
  /// Crea una [CircularProgressBar].
  ///
  /// Los parámetros [size], [percentage], [backgroundColor], [percentageColor] y [strokeWidth] son opcionales.
  /// El [percentage] debe estar entre 0 y 100. El [strokeWidth] debe ser mayor que 0.
  const CircularProgressBar({
    ...
    this.strokeWidth = 5,
        ...
        assert(strokeWidth > 0, 'El grosor debe ser mayor que 0');
              ...
              return SizedBox(
                ...
                child: CustomPaint(
                  painter: _RadialProgressBar(
                    percentage: (widget.percentage - difference) + (difference * _controller.value),
...
class _RadialProgressBar extends CustomPainter {
  ...
  /// Crea un [_RadialProgressBar].
  ///
  /// Los parámetros [percentage], [backgroundColor], [percentageColor] y [strokeWidth] son obligatorios.
  _RadialProgressBar({
